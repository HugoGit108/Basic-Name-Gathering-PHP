            ...
            <div class="card p-4">
                ...
                <div class="row justify-content-center">
                    <div class="col-10">
                        ...
                        <p class="text-center">Carregar ficheiro em formato XLSX ou CSV. Se não tem o template do ficheiro, faça download <a href="../public/uploads/file_templates/BNG_template.xlsx">AQUI</a></p>
                        ...
                        <form action="?ct=agent&mt=upload_file_submit" method="post" enctype="multipart/form-data">
                            ...
                            <?php if (isset($report)): ?>
                                <ul class="alert alert-success ps-5 fw-bold">
                                    <li><?= "Ficheiro: " . $report['filename'] ?></li>
                                    <li><?= 'Total: ' . $report['total'] ?></li>
                                    <li><?= 'total carregados: ' . $report['totalCarregados'] ?></li>
                                    <li><?= 'total não carregados: ' . $report['totalNaoCarregados'] ?></li>
                                </ul>
                            <?php endif; ?>
